...
CREATE FUNCTION [dbo].[depo_user_sets_sql2] (@user_id int, @right_name varchar(100) = 'ÍÀáÅÀ')
RETURNS TABLE
AS
RETURN
	SELECT DISTINCT S.SET_ID, S.JOIN_SQL, S.WHERE_SQL, S.IS_EXCEPTION
	FROM dbo.DEPO_SETS2 S
		INNER JOIN dbo.DEPO_SET_RIGHTS2 SR ON SR.SET_ID = S.SET_ID
