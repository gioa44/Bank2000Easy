...
CREATE FUNCTION [dbo].[depo_fn_rep_get_before_annul_realize_interest](@depo_id int)
--აბრუნდებს დარღვევამდე რეალიზებულ პროცენტს
RETURNS money
AS
BEGIN
	DECLARE
	...
	SET @result = @op_data.value('(row/@DEPO_REALIZE_INTEREST)[1]', 'money')
