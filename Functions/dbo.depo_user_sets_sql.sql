...
SET ANSI_NULLS ON
GO
CREATE FUNCTION [dbo].[depo_user_sets_sql] (@user_id int, @right_name varchar(100) = 'ÍÀáÅÀ')
RETURNS TABLE
AS
RETURN
	SELECT DISTINCT S.SET_ID, S.JOIN_SQL, S.WHERE_SQL, S.IS_EXCEPTION
	FROM dbo.DEPO_SETS S
		INNER JOIN dbo.DEPO_SET_RIGHTS SR ON SR.SET_ID = S.SET_ID
