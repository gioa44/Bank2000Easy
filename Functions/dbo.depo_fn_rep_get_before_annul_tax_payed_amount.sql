...
CREATE FUNCTION [dbo].[depo_fn_rep_get_before_annul_tax_payed_amount](@depo_id int)
--აბრუნდებს დარღვევამდე დაბეგრილ პროცენტს
RETURNS money
AS
BEGIN
	DECLARE
	...
	SET @result = @op_data.value('(row/@TOTAL_TAX_PAYED_AMOUNT)[1]', 'money')
