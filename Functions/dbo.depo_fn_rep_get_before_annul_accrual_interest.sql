...
CREATE FUNCTION [dbo].[depo_fn_rep_get_before_annul_accrual_interest](@depo_id int)
--აბრუნდებს დარღვევამდე დარიცხულ არარეალიზებულ პროცენტს
RETURNS money
AS
BEGIN
	DECLARE
	...
	SET @result = @op_data.value('(row/@CALC_AMOUNT)[1]', 'money')
