...
CREATE VIEW [dbo].[PENDING_PAYMENTS_ARC_VIEW]
AS
SELECT	A.DOC_REC_ID, A.IS_ONLINE, A.PROVIDER_ID, A.SERVICE_ALIAS, A.DOC_TYPE, A.OWNER, A.DEPT_NO, A.CHANNEL_ID, A.REC_STATE, 
        ...
        C.SERVICE_NAME, D.USER_NAME, dbo.get_pending_acc(A.DOC_REC_ID, A.DOC_TYPE, 1) AS SENDER_ACC, 
        dbo.get_pending_acc_name(A.DOC_REC_ID, A.DOC_TYPE, 1) AS SENDER_ACC_NAME
FROM	dbo.PENDING_PAYMENTS_ARC (NOLOCK) AS A INNER JOIN
