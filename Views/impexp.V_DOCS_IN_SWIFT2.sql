...
CREATE VIEW [impexp].[V_DOCS_IN_SWIFT2] AS
SELECT D.*, 
...
FROM impexp.DOCS_IN_SWIFT D
	...
	INNER JOIN impexp.PORTIONS_IN_SWIFT PS ON PS.PORTION_DATE = D.PORTION_DATE AND PS.PORTION = D.PORTION
