...
SET ANSI_NULLS ON
GO
CREATE VIEW [dbo].[LOAN_VW_LOAN_REPS]
AS
SELECT
	...
	L.CLIENT_NO, C.DESCRIP AS CLIENT_DESCRIP, 
	COALESCE(C.PERSONAL_ID, C.TAX_INSP_CODE) AS CLIENT_UNIQUE_ID,
	C.CLIENT_NO AS CLIENT_ID,
	C.DESCRIP_LAT AS CLIENT_DESCRIP_LAT,
