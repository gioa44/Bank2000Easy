CREATE TABLE [dbo].[LOAN_OP_SCHEDULE]
(
[OP_ID] [int] NOT NULL,
...
GO
ALTER TABLE [dbo].[LOAN_OP_SCHEDULE] ADD CONSTRAINT [PK_LOAN_OP_SCHEDULE] PRIMARY KEY CLUSTERED  ([OP_ID], [LOAN_ID], [SCHEDULE_DATE]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[LOAN_OP_SCHEDULE] ADD CONSTRAINT [FK_LOAN_OP_SCHEDULE_LOAN_OPS] FOREIGN KEY ([OP_ID]) REFERENCES [dbo].[LOAN_OPS] ([OP_ID]) ON DELETE CASCADE
GO
