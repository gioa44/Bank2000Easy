CREATE TABLE [dbo].[PLASTIC_CARDS_ARC]
(
...
[CONDITION_SET] [char] (3) COLLATE Latin1_General_BIN NULL,
[CARD_ID_OLD] [varchar] (19) COLLATE Latin1_General_BIN NULL,
[CLIENT_CATEGORY] [varchar] (3) COLLATE Latin1_General_BIN NULL,
[USER_ID] [smallint] NULL,
[PROD_CODE] [varchar] (50) COLLATE Latin1_General_BIN NOT NULL CONSTRAINT [DF_PLASTIC_CARDS_ARC] DEFAULT (''),
[AUTHORIZE_CODE] [tinyint] NOT NULL CONSTRAINT [DF_PLASTIC_CARDS_ARC_AUTHORIZE_CODE] DEFAULT ((0)),
[AGR_RISK_LEVEL] [varchar] (5) COLLATE Latin1_General_BIN NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[PLASTIC_CARDS_ARC] ADD CONSTRAINT [PK_PLASTIC_CARDS_ARC] PRIMARY KEY CLUSTERED  ([CARD_ID]) ON [PRIMARY]
GO
