...
[IS_EXCEPTION] [bit] NOT NULL CONSTRAINT [DF_ACC_SETS_IS_EXCEPTION] DEFAULT ((0)),
[DESCRIP_LAT] [varchar] (100) COLLATE Latin1_General_BIN NULL
) ON [PRIMARY]
GO
ALTER TABLE [dbo].[ACC_SETS] ADD CONSTRAINT [PK_ACC_SETS] PRIMARY KEY CLUSTERED  ([SET_ID]) ON [PRIMARY]
GO
