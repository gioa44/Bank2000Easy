...
GO
ALTER TABLE [dbo].[LOAN_DETAILS] ADD CONSTRAINT [CK_LOAN_DETAILS_MAX_CATEGORY_LEVEL] CHECK (([MAX_CATEGORY_LEVEL] IS NULL OR [MAX_CATEGORY_LEVEL]=(6) OR [MAX_CATEGORY_LEVEL]=(5) OR [MAX_CATEGORY_LEVEL]=(4) OR [MAX_CATEGORY_LEVEL]=(3) OR [MAX_CATEGORY_LEVEL]=(2) OR [MAX_CATEGORY_LEVEL]=(1)))
GO
ALTER TABLE [dbo].[LOAN_DETAILS] ADD CONSTRAINT [PK_LOAN_DETAILS] PRIMARY KEY CLUSTERED  ([LOAN_ID]) ON [PRIMARY]
GO
ALTER TABLE [dbo].[LOAN_DETAILS] ADD CONSTRAINT [FK_LOAN_DETAILS_LOANS] FOREIGN KEY ([LOAN_ID]) REFERENCES [dbo].[LOANS] ([LOAN_ID]) ON DELETE CASCADE
GO
