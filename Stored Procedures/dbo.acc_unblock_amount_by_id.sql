...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[acc_unblock_amount_by_id] (
	@acc_id int,
	@block_id int,
	@user_id int,
	@doc_rec_id int
...
SET @amount = AMOUNT, @fee = FEE,
	IS_ACTIVE = 0, UNBLOCKED_BY_USER = @user_id, UNBLOCK_DATE_TIME = GETDATE(), DOC_REC_ID = @doc_rec_id
