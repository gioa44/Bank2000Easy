...
CREATE PROCEDURE [dbo].[depo_show_depo_rights_2]
	@depo_id int,
	@user_id int
AS
...
SET @sql_str0 = N'IF EXISTS(SELECT * FROM dbo.DEPO_DEPOSITS D(NOLOCK) '
...
FROM dbo.depo_user_sets_sql2(@user_id, null)
