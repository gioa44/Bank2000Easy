...
CREATE PROCEDURE [impexp].[send_doc_prepared_cancel_swift]
	@doc_rec_id int,
	@uid int,
	@user_id int
AS
...
DECLARE @r int
EXEC @r = impexp.check_send_doc_prepared_cancel_swift @doc_rec_id, @user_id
...
VALUES (@doc_rec_id, @user_id, 36, 'ÓÀÁÖÈÉÓ ÛÄÓßÏÒÄÁÉÓ ÃÄÀÅÔÏÒÉÆÀÝÉÀ')
IF @@ERROR <> 0 BEGIN ROLLBACK RETURN 1 END
