...
CREATE PROCEDURE [impexp].[swift_message_builder940]
	@rec_id int,
	@uid int,
	@acc_id int,
	@bic TINTBANKCODE,
...
SELECT DT, DBO, CRO, convert(varchar(20), DOC_NUM), convert(varchar(20), ACCOUNT), SW_CODE, SW_CODE_DESCRIP FROM impexp.STATEMENT_DETAILS (NOLOCK)
