...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[fp_add_doc_withdraw]
	@rec_id int OUTPUT,
	@user_id int, 
	@dept_no int, 
	@fp_sys_id int, 
...
SELECT @use_head_branch_accounts = USE_HEAD_BRANCH_ACCOUNTS, @transit_acc = TRANSIT_ACC_WITHDRAW, @profit_acc = PROFIT_ACC_WITHDRAW, @alias = ALIAS
...
SET @descrip = @alias + ' ÓÉÓÔÄÌÉÈ ÈÀÍáÉÓ ÂÀÍÀÙÃÄÁÀ'
...
IF @amount2 > $0.00
BEGIN
	SET @descrip = @alias + ' ÓÉÓÔÄÌÉÈ ÈÀÍáÉÓ ÂÀÍÀÙÃÄÁÉÓ ÓÀÊÏÌÉÓÉÏ'
