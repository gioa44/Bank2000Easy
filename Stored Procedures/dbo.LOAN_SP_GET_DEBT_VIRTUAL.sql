...
CREATE PROCEDURE [dbo].[LOAN_SP_GET_DEBT_VIRTUAL]
  @loan_id int,
  @amount money = null,
...
BEGIN
	...
	SET @no_charge_debt = @min_debt + @interest + @nu_interest + @no_charge_prepayment + @insurance + @service_fee +
	...
	BEGIN
		SET @min_debt = @min_debt + @next_principal + @interest + @nu_interest + @insurance + @service_fee + @defered_interest + @defered_overdue_interest + @defered_penalty + @defered_fine
