...
CREATE PROCEDURE [dbo].[client_sp_get_convert_amount]
	@client_no int,
	@iso1 char(3),
	@iso2 char(3),
	@amount money,
	@new_amount TAMOUNT = NULL out,
	@look_buy bit = 1,
	@rate_amount money out,
	@rate_items int out,
	@reverse bit out,
	@show_result bit = 0
AS
 SET NOCOUNT ON;
	...
	EXEC @r = dbo.ROUND_BY_ISO @new_amount,@iso2, @new_amount OUTPUT
