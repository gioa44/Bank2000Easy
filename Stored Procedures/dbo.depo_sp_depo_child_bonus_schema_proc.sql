...
CREATE PROCEDURE [dbo].[depo_sp_depo_child_bonus_schema_proc]
	@depo_id int,
	@user_id int,
	@dept_no int,
...
SET @accrue_amount = ROUND(@accrue_amount, 2)

SET @remark = 'áÄËÛÄÊÒÖËÄÁÉÈ ÂÀÈÅÀËÉÓßÉÍÄÁÖËÉ ÐÉÒÏÁÄÁÉ ÁÏÍÖÓÉÓÈÅÉÓ ÛÄÓÒÖËÄÁÖËÉÀ'
