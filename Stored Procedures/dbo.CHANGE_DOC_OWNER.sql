...
UPDATE dbo.OPS_0000
SET UID = UID + 1, OWNER = @new_owner, @parent_rec_id = PARENT_REC_ID
...
SET @descrip = 'ÓÀÁÖÈÉÓ ÐÀÔÒÏÍÉÓ ÛÄÝÅËÀ : '+ convert(varchar(20), @new_owner)
