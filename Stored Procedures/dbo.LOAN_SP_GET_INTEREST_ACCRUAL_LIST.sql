...
CREATE PROCEDURE [dbo].[LOAN_SP_GET_INTEREST_ACCRUAL_LIST]
...
SET @sql_str = 'SELECT L.STATE, A.* FROM dbo.LOAN_VW_INTEREST_ACCRUAL_LIST A (NOLOCK) INNER JOIN dbo.LOANS L ON L.LOAN_ID=A.LOAN_ID'
