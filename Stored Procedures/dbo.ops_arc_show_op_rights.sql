...
CREATE PROCEDURE [dbo].[ops_arc_show_op_rights]
	@doc_id int,
	@user_id int
AS
...
SET @sql_str0 = N'IF EXISTS(SELECT * FROM dbo.OPS_ARC O(NOLOCK) '
...
FROM dbo.ops_arc_user_sets_sql(@user_id, null)
